import { TopNavBar, Footer, CatalogCard, ProductGallery } from "@/ui";
...
export default async function ProductPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
      ...
      {/* Main Content Canvas */}
      <main className="w-full pb-xl min-h-screen pt-20">
              ...
              <div className="mt-auto flex flex-col gap-sm">
                <div className="flex items-center gap-sm">
                  ...
                  <div className="flex items-center border border-outline-variant rounded-lg bg-surface-container-lowest h-12 w-32">
                    <button aria-label="Decrease quantity" className="w-10 h-full flex items-center justify-center text-on-surface-variant hover:text-primary transition-colors">
                    ...
                    <input
                      ...
                      defaultValue="1"
                    />
                    <button aria-label="Increase quantity" className="w-10 h-full flex items-center justify-center text-on-surface-variant hover:text-primary transition-colors">
